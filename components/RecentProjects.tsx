        ...
        {projects.map(({ title, des, img, iconLists, link, id }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              ...
              >
                <div className="realtive w-full h-full overflow-hidden lg:rounded-3xl
                bg-[#13162d] ">
                ...
                <div className="flex items-center">
                    {iconLists.map((icon,index)=>(
                        ...
                        style={{transform:`translateX(-${5 * index * 2}px)`}}>
                            <img src={icon} alt={icon} className="pt-2"
                            />
                        </div>
                    ))}
                </div>
                <div className="flex items-center justify-center">
                    <p className="flex text-purple lg:text-xl md:text-xs text-sm font-sans ">
                        Visit Site
                    </p>
